...
<head>
   ...
   <title>Atualizar produto | Dev Brasil</title>
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="number" min="0" max="9999999999" required placeholder="insira o preço do produto" name="price" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['price']; ?>">
