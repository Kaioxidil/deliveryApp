...
<head>
   ...
   <title>Pontas de usuários | Dev Brasil</title>
...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" class="delete-btn" onclick="return confirm('excluir esta conta?');">Deletar</a>
   </div>
   <?php
      }
   }else{
