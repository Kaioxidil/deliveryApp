...
<head>
   ...
   <title>Pedidos feitos | Dev Brasil</title>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <div class="flex-btn">
            ...
            <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('excluir este pedido?');">Deletar</a>
         </div>
      </form>
   </div>
   <?php
